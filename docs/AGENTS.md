...
This document introduces the specialized AI agents across all BMAD modules in this repository.
...
### Extended Intelligence Disciplines (3)
...
## BMM Module (BMAD Method for Software)

Core software development agents for the BMAD methodology.

| Agent | Role |
|-------|------|
| Analyst | Requirements analysis and discovery |
...
## BMGD Module (BMAD for Game Development)

Game development specialized agents extending BMM.

| Agent | Role |
|-------|------|
| Game Designer | Mechanics, systems, and GDD creation |
| Narrative Designer | Story, dialogue, and world-building |
| Game Architect | Engine-specific architecture |
| Game Dev | Implementation with game-specific patterns |

---

## BMB Module (BMAD Module Builder)

Meta-module for creating new BMAD modules.

| Agent | Role |
|-------|------|
| Agent Builder | Creates new BMAD agents |
| Workflow Builder | Designs and creates workflows |
| Module Builder | Assembles complete modules |
