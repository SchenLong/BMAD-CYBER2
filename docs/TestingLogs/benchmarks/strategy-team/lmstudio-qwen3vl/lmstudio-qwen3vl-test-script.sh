#!/bin/bash
# LM Studio Qwen3-VL-30B Crisis Scenario Benchmark
# Run each strategic agent ONE AT A TIME

OUTPUT_DIR="/Users/paultinp/BMAD-CYBER2/_bmad-output/qa-test-logs/lmstudio-qwen3vl-results"
mkdir -p "$OUTPUT_DIR"
...
echo "Starting LM Studio Qwen3-VL-30B Crisis Benchmark"
echo "Model: $MODEL"
echo "=============================================="
echo ""
