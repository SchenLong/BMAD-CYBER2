#!/bin/bash
# LM Studio Qwen 32B Abliterated Intel Scenario Benchmark
# Run each intel agent ONE AT A TIME

OUTPUT_DIR="/Users/paultinp/BMAD-CYBER2/_bmad-output/qa-test-logs/intel-lmstudio-qwen32abl-results"
mkdir -p "$OUTPUT_DIR"
...
echo "Starting LM Studio Qwen 32B Abliterated Intel Benchmark"
echo "Model: $MODEL"
echo "=============================================="
echo ""
