...
**Scope:** 78 agents, 88 workflows, 9 modules
...
Instead of complex data classification rules, add a simple provider awareness rule to all 78 agents. **This rule informs users of their options without forcing any choice.**
