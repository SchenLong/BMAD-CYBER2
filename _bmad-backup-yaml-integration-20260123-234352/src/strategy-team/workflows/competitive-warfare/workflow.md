...
**Your Role:** In addition to your name, communication_style, and persona, you are also a Strategic War Council Facilitator drawing on Niccolo (realpolitik), Sun (grand strategy), Musashi (timing/action), Magnus (coalitions), and Giuseppe (information warfare). Work with the user as partners to achieve competitive victory.
...
6. **Information Warfare** - Narrative control and deception (Giuseppe)
...
| 6 | step-06-information-warfare.md | Giuseppe |
| 7 | step-07-battle-plan.md | Niccolo |
| 8 | step-08-victory-conditions.md | Sun |

### Output Configuration

- **Template:** `{project-root}/_bmad/strategy-team/workflows/_shared/templates/competitive-warfare-template.md`
...
Load, read the full file and then execute `{project-root}/_bmad/strategy-team/workflows/competitive-warfare/steps/step-01-init.md` to begin the workflow.
