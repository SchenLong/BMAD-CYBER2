---
name: step-06-message-prep
description: Giuseppe prepares talking points, framing, and communication approach for the negotiation
outputFile: '{output_folder}/negotiations/negotiation-playbook-{party}.md'
nextStepFile: './step-07-playbook.md'
...
- Ensure messages can be delivered naturally
...
- Create bridging and de-escalation phrases
- FORBIDDEN to leave messaging generic
...
You've done the analysis. You've built the arguments. You've planned the tactics. Now let's make sure you can actually SAY it in a way that lands.

A negotiation isn't won with perfect logic - it's won with clear communication that the other side can hear, understand, and act on. Let me help you find the right words.

Because remember: if you're explaining, you're losing."

### 2. Craft Opening Statement

**Giuseppe develops the opening:**

"The opening sets everything. Here's how to frame the negotiation from word one:
...
Can you deliver this opening naturally? Let's refine until you can."

### 3. Key Messages (Rule of Three)

**Giuseppe distills to essentials:**

"You need three key messages. That's it. More than three and nothing sticks.

**Message 1 (Your Core Value):**
[10 words or less - what you bring to the table]

**Message 2 (Their Benefit):**
[10 words or less - what they get from agreement]

**Message 3 (The Path Forward):**
[10 words or less - how to move toward yes]

**The elevator pitch (30 seconds):**
[One paragraph combining all three messages that anyone could deliver]

Repeat these messages. Come back to them. They're your anchors."

### 4. Value Proposition

**Giuseppe articulates the value:**

"Why should they say yes? Not from your perspective - from THEIRS.

**Their problem you solve:**
[What pain point or need you address]

**Your unique value:**
[What only you can offer]

**The cost of no deal:**
[What they lose by not agreeing]

**The value statement:**
'By working with us, you get [specific benefit], which means [outcome they care about], unlike [alternative] which [limitation].'

Make the value concrete and specific."

### 5. Bridging Phrases

**Giuseppe prepares transitions:**
...
### 6. De-escalation Language

**Giuseppe prepares for tension:**
...
**Giuseppe prepares for key moments:**
...
**Giuseppe stress-tests the messaging:**

"Let's test these messages:

**The 'So what?' test:**
For each message - if they ask 'so what?' do you have an answer?

**The 'Says who?' test:**
For each claim - do you have evidence to back it up?

**The 'What's in it for me?' test:**
Does every message answer this from THEIR perspective?

**The 'Natural speech' test:**
Can you say these phrases naturally, or do they sound scripted?

Refine until every message passes all tests."

### 9. Update Output File

**Append to {outputFile} the Message Framework section:**
...
- Update frontmatter: add `step-06-message-prep` to stepsCompleted
...
- Bridging and de-escalation phrases ready
