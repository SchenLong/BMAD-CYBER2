...
4. Core terms drafting
5. Risk allocation provisions
6. Boilerplate customization for jurisdiction
7. Internal cross-reference check
...
- Employment contracts (coordinate with Gremio for Spain)
