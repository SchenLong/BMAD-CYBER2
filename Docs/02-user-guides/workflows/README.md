...
Complete reference for all workflows across BMAD modules.

---

## Team-Specific Workflow Guides

For detailed, user-focused guides on each team's workflows, see:

- **[Cybersec Team Workflows](cybersec-workflows.md)** - Security operations, incident response, compliance
- **[Intel Team Workflows](intel-workflows.md)** - Intelligence operations, OSINT, threat analysis
- **[Legal Team Workflows](legal-workflows.md)** - Contract review, corporate formation, dispute strategy
- **[Strategy Team Workflows](strategy-workflows.md)** - Executive leadership, crisis response, strategic planning
...
| Workflow | Steps | Purpose |
|----------|-------|---------|
| **the-synthesis** | 4 | Multi-INT fusion and comprehensive intelligence product creation |
| **campaign-ai** | 4 | AI-augmented intelligence analysis and prediction |
...
| Workflow | Purpose |
|----------|---------|
| `workflow-init` | Initialize new BMM project |
...
| `create-story` | Individual story creation |
...
## BMGD Workflows (Game Development)

| Workflow | Purpose |
|----------|---------|
| `workflow-init` | Initialize game project |
...
| `brainstorm-game` | Game brainstorming |
| `sprint-planning` | Sprint tracking for games |
| `dev-story` | Game story implementation |
| `code-review` | Game code review |

### Game TestArch Workflows

| Workflow | Purpose |
|----------|---------|
| `gametest-test-design` | Game test scenarios |
| `gametest-framework` | Game test framework |
| `gametest-automate` | Automated game tests |
| `gametest-performance` | Performance testing |
| `gametest-playtest-plan` | Playtesting sessions |
