...
| **Hook Guardrails** | 19 pre-execution security validators | [HOOKS-VALIDATORS-GUIDE.md](../../../06-reference/features/HOOKS-VALIDATORS-GUIDE.md) |
...
| **Context Management (OWASP LLM04)** | Token tracking with 75%/95% thresholds | [HOOKS-VALIDATORS-GUIDE.md](../../../06-reference/features/HOOKS-VALIDATORS-GUIDE.md) |
| **Resource Limits (OWASP LLM04)** | Memory (4GB), recursion, process limits | [HOOKS-VALIDATORS-GUIDE.md](../../../06-reference/features/HOOKS-VALIDATORS-GUIDE.md) |
| **Confidence Tracking (OWASP LLM09)** | Uncertainty detection and scoring | [HOOKS-VALIDATORS-GUIDE.md](../../../06-reference/features/HOOKS-VALIDATORS-GUIDE.md) |
