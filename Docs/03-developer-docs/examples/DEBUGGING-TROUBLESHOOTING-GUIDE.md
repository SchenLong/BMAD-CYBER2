...
- **Technical Support**: support@blackunicorn.tech
- **Architecture Consultation**: architects@blackunicorn.tech
- **Documentation Issues**: docs@blackunicorn.tech
...
async function checkNetworkConnectivity(client: BmadClient): Promise<void> {
  const endpoints = [
    ...
    'https://cdn.blackunicorn.tech/modules/',
    'https://registry.blackunicorn.tech/v2/'
  ];
...
- [Status Page](https://status.blackunicorn.tech)
...
*This debugging guide is maintained by the BMAD Developer Experience team. For updates or suggestions, please contact docs@blackunicorn.tech*
