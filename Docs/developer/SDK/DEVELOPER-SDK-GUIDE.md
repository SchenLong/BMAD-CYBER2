...
|----------|---------|------------|-----------------|
| **JavaScript/TypeScript** | 18+ | [@bmad/sdk-js](https://npm.bmad.code) | npm/yarn |
| **Python** | 3.9+ | [bmad-sdk-python](https://pypi.bmad.code) | pip/conda |
| **Go** | 1.19+ | [github.com/bmad/sdk-go](https://pkg.go.dev) | go modules |
| **Java** | 11+ | [com.bmad:sdk-java](https://maven.bmad.code) | Maven/Gradle |
| **C#** | .NET 6+ | [BMad.SDK](https://nuget.bmad.code) | NuGet |
