...
stepsCompleted: []
createdDate: {date}
workflow: performance-review-preparation
status: draft
employeeName: ""
reviewType: ""
reviewPeriod: ""
...
| Employee comments | 1 week | Employee |
| Submit to HR | Per policy | Manager |
| Begin development | 2 weeks | Both |
| Follow-up check-in | 30 days | Manager |
