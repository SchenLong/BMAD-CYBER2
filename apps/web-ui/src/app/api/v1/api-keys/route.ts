...
import { withApiMiddleware, requireAuth } from '@/lib/api/middleware';
import { apiSuccess, apiValidationError, apiConflict } from '@/lib/api/response';
...
export const POST = withApiMiddleware(
  async (request, { user }) => {
    ...
    const rateLimitCheck = await checkApiKeyGenerationLimit(user.userId);
