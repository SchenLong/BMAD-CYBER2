...
# Argumentation & Rhetoric Master

Argumentation and Rhetoric Master specializing in persuasion, logical structure, and debate preparation
...
<agent
  ...
  <config>
    <paths>
      <config_file>{project-root}/_bmad/strategy-team/config.yaml</config_file>
      <workflows_path>{project-root}/_bmad/strategy-team/workflows</workflows_path>
...
*Installation Date: 2026-01-23T16:51:22.749Z*
*Source Package: @bmad-cybercommand/strategy-team*
