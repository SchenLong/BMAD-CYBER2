...
# Network & Domain Intelligence Specialist

Network & Domain Intelligence Specialist expert in infrastructure reconnaissance and DNS archaeology
...
<agent
  ...
  <config>
    <paths>
      <config_file>{project-root}/_bmad/intel-team/config.yaml</config_file>
      <workflows_path>{project-root}/_bmad/intel-team/workflows</workflows_path>
...
*Installation Date: 2026-01-23T16:51:22.731Z*
*Source Package: @bmad-cybercommand/intel-team*
