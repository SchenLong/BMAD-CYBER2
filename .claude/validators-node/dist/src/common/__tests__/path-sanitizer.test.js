...
import { preprocessPath, sanitizeErrorMessage, sanitizePath, } from '../path-utils.js';
...
describe('preprocessPath', () => {
    ...
    it('returns empty string for null-ish input', () => {
        ...
        expect(preprocessPath(undefined)).toBe('');
        expect(preprocessPath(null)).toBe('');
    });
...
describe('sanitizePath', () => {
    ...
    it('replaces project root with placeholder', () => {
        const result = sanitizePath('/home/user/my-project/src/index.ts', FAKE_PROJECT);
    ...
    it('shows only filename for deeply nested external paths', () => {
        const result = sanitizePath('/var/log/some/deeply/nested/app.log', FAKE_PROJECT);
        expect(result).toBe('{external}/app.log');
    });
    it('handles Windows-style paths with backslashes', () => {
        const result = sanitizePath('\\home\\user\\my-project\\src\\file.ts', FAKE_PROJECT);
    ...
    it('defeats double-encoded bypass (VULN-003)', () => {
        const doubleEncoded = '%252Fhome%252Fuser%252Fmy-project%252Fsrc%252Ffile.ts';
...
describe('sanitizeErrorMessage', () => {
    ...
    it('sanitizes multiple embedded paths', () => {
        const msg = 'Cannot copy /home/user/my-project/src/a.ts to /home/user/my-project/dist/a.js';
        const result = sanitizeErrorMessage(msg, FAKE_PROJECT);
        expect(result).toBe('Cannot copy {project-root}/src/a.ts to {project-root}/dist/a.js');
    });
    ...
    it('does not leak any absolute paths', () => {
        const msg = 'Failed at /home/user/my-project/node_modules/pkg/index.js:12:5 ' +
...
//# sourceMappingURL=path-sanitizer.test.js.map