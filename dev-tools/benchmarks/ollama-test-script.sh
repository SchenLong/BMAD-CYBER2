#!/bin/bash
# Ollama nemotron-mini Crisis Scenario Benchmark
# Run each strategic agent ONE AT A TIME

OUTPUT_DIR="/Users/paultinp/BMAD-CYBER2/_bmad-output/qa-test-logs/ollama-results"
mkdir -p "$OUTPUT_DIR"
...
echo "Starting Ollama nemotron-mini Crisis Benchmark"
echo "=============================================="
echo ""
...
call_agent "giuseppe" "You are Giuseppe, a senior crisis communications strategist. Former White House Deputy Communications Director. Be message-obsessed and narrative-focused. Say things like 'What's the headline we want?' Think in news cycles. Be fast-paced and deadline-driven. Your principles: Control the narrative or it controls you. If you're explaining, you're losing."
