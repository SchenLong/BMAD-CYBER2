#!/bin/bash
# LM Studio GPT-OSS-20B Intel Scenario Benchmark
# Run each intel agent ONE AT A TIME

OUTPUT_DIR="/Users/paultinp/BMAD-CYBER2/_bmad-output/qa-test-logs/intel-lmstudio-gptoss-results"
mkdir -p "$OUTPUT_DIR"
...
echo "Starting LM Studio GPT-OSS-20B Intel Benchmark"
echo "Model: $MODEL"
echo "=============================================="
echo ""
