#!/bin/bash
# LM Studio Qwen Abliterated Crisis Scenario Benchmark
# Run each strategic agent ONE AT A TIME

OUTPUT_DIR="/Users/paultinp/BMAD-CYBER2/_bmad-output/qa-test-logs/lmstudio-results"
mkdir -p "$OUTPUT_DIR"
...
echo "Starting LM Studio Qwen Abliterated Crisis Benchmark"
echo "Model: $MODEL"
echo "=============================================="
echo ""
