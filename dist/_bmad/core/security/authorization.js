...
export class AuthorizationManager {
    ...
    canAccessModule(user, moduleName) {
        ...
        if (restriction) {
            ...
            const hasRequiredRole = user.roles.some(r => restriction.require_roles.includes(r));
            if (!hasRequiredRole) {
                return {
                    allowed: false,
    ...
    canAccessAgent(user, agentPath) {
        ...
        if (agentRestriction) {
            const hasRequiredRole = user.roles.some(r => agentRestriction.require_roles.includes(r));
            if (!hasRequiredRole) {
                return {
                    allowed: false,
...
// ============================================================================
let _instance = null;
export function getAuthorizationManager(configPath) {
...
export function resetAuthorizationManager() {
    _instance = null;
}
// ============================================================================
// CLI Entry Point
