    ...
    async resolveDependencies(modules) {
        ...
        try {
            ...
            for (let i = 0; i < modules.length; i++) {
                ...
                this.progressReporter.updateProgress(`Analyzing ${module}...`, Math.round(((i + 1) / modules.length) * 80));
    ...
    async executeInstallation(dependencyGraph) {
        ...
        try {
            for (let i = 0; i < modules.length; i++) {
                ...
                this.progressReporter.updateProgress(`Installing ${module}...`, Math.round(((i + 1) / modules.length) * 100));
