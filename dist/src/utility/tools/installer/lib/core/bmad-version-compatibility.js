...
class BMADVersionChecker {
    ...
    validateDependencyTree(dependencyTree) {
        ...
        for (const [moduleName, moduleConfig] of Object.entries(dependencyTree)) {
            const validation = this.validateModuleCompatibility(moduleName, moduleConfig.version, moduleConfig);
    ...
    generateCompatibilityReport() {
        ...
        for (const [moduleName, moduleInfo] of this.loadedModules) {
            const validation = this.validateModuleCompatibility(moduleName, moduleInfo.version, moduleInfo.dependencies);
...
//# sourceMappingURL=bmad-version-compatibility.js.map