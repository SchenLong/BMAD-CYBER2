...
class BMADPostInstallVerifier {
    ...
    async checkVersionConsistency(moduleConfig, context) {
        try {
            const packageJsonPath = path.join(context.installationPath || `./node_modules/${moduleConfig.npm?.full_name}`, 'package.json');
...
//# sourceMappingURL=bmad-post-install-verifier.js.map