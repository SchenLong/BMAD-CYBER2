...
class PrivilegeEscalationProtection {
    ...
    triggerSecurityAlert(alertType, details) {
        ...
        fs.appendFileSync('/Users/paultinp/BMAD-CYBER2/security-testing/alerts/privilege-escalation-alerts.log', JSON.stringify(securityAlert) + '\n');
    }
    getAuditLog() {
...
//# sourceMappingURL=privilege-escalation-security-patch.js.map