 ...
 */
import type { ValidationResult, DependencyInfo, DependencyGraph, TemplateData, FileGenerationResult, InstallationSession, HealthCheckResult } from './types.js';
/**
...
export interface IConfigurationManager {
     ...
     */
    saveConfiguration(configPath: string, config: Record<string, unknown>): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
     ...
     */
    mergeConfigurations(baseConfig: Record<string, unknown>, ...configs: Record<string, unknown>[]): Record<string, unknown>;
    /**
...
export interface IConfigurationValidator {
     ...
     */
    validateAgainstSchema(config: Record<string, unknown>, schema: Record<string, unknown>): Promise<ValidationResult>;
    /**
     ...
     */
    registerValidationRule(name: string, rule: (value: unknown, context: Record<string, unknown>) => boolean | string): void;
    /**
...
export interface IModuleRegistry {
     ...
     * Register a module
     */
    register(name: string, manifest: Record<string, unknown>): Promise<{
        success: boolean;
        error?: string;
    }>;
    /**
...
export interface IBackupManager {
     ...
     */
    createBackup(files: string[], backupName?: string): Promise<{
        success: boolean;
        backupId?: string;
        error?: string;
    }>;
...
export declare const ServiceTokens: {
    ...
    readonly CONFIGURATION_MANAGER: "IConfigurationManager";
    readonly CONFIGURATION_VALIDATOR: "IConfigurationValidator";
    readonly DEPENDENCY_MANAGER: "IDependencyManager";
    readonly POST_INSTALL_VERIFIER: "IPostInstallVerifier";
    readonly FILE_SYSTEM: "IFileSystem";
    readonly LOGGER: "ILogger";
    readonly CACHE: "ICache";
    readonly MODULE_REGISTRY: "IModuleRegistry";
    readonly BACKUP_MANAGER: "IBackupManager";
    readonly SECURITY_VALIDATOR: "ISecurityValidator";
};
