...
export declare function isValidationStep(step: InstallationStep): step is InstallationStep & {
    type: 'validation';
};
export declare function isDependencyResolutionStep(step: InstallationStep): step is InstallationStep & {
    type: 'dependency_resolution';
};
export declare function isTemplateProcessingStep(step: InstallationStep): step is InstallationStep & {
    type: 'template_processing';
};
export declare function isFileGenerationStep(step: InstallationStep): step is InstallationStep & {
    type: 'file_generation';
};
export declare function isSuccessfulResult(result: InstallationResult): result is InstallationResult & {
    success: true;
};
export declare function isFailedResult(result: InstallationResult): result is InstallationResult & {
    success: false;
    error: string;
};
export declare function validateOrchestratorConfig(config: OrchestratorConfig): ValidationResult;
