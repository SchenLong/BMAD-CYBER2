...
class PerformanceBenchmark {
    ...
    async generatePerformanceReport() {
        ...
        if (this.benchmarkResults.installation.totalInstallTime > 5000)
            performanceScore -= 20;
        if (this.benchmarkResults.agentLoading.avgLoadTimePerAgent > 100)
            performanceScore -= 20;
        if (this.benchmarkResults.memoryUsage.memoryPerAgent > 100)
            performanceScore -= 15;
        if (this.benchmarkResults.fileSystem.concurrentSpeedup < 2)
            performanceScore -= 15;
...
//# sourceMappingURL=bmad-performance-benchmark.js.map