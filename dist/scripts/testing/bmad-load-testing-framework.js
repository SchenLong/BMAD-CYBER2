...
class LoadTestingFramework {
    ...
    calculateOverallScore(scenarios) {
        ...
        const peakMemoryUsage = Math.max(...scenarios.map(s => s.peakMemoryMB));
        if (peakMemoryUsage > this.results.system.availableMemory * 0.9)
            score -= 25;
        else if (peakMemoryUsage > this.results.system.availableMemory * 0.7)
            score -= 15;
...
//# sourceMappingURL=bmad-load-testing-framework.js.map