...
class ComprehensivePerformanceAnalyzer {
    ...
    async generateTechnicalReport() {
        ...
        overallScore = Math.round(performanceMetrics.reduce((sum, metric) => sum + metric.score, 0) / performanceMetrics.length);
...
//# sourceMappingURL=STORY-2.2-PERFORMANCE-ANALYSIS-COMPREHENSIVE.js.map