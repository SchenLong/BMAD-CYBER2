...
<persona>
  ...
  <menu>
    ...
    <item cmd="MT or fuzzy match on mobile-test or pentest" workflow="{project-root}/_bmad/cybersec-team/workflows/mobile-security-testing">[MT] Mobile Security Test - Mobile app penetration testing workflow</item>
