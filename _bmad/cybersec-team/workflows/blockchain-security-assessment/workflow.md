...
Load, read the full file and then execute `{project-root}/_bmad/cybersec-team/workflows/blockchain-security-assessment/steps/step-01-init.md` to begin the workflow.
