...
workflow_path: '{project-root}/_bmad/cybersec-team/workflows/cloud-security-assessment'
...
ONLY WHEN compliance mapping is documented and user confirms readiness will you update frontmatter to `stepsCompleted: [1, 2, 3, 4, 5, 6, 7]`, then immediately load, read entire file, then follow `{nextStepFile}`.
