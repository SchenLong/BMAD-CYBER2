...
- **Template:** `{project-root}/_bmad/strategy-team/workflows/_shared/templates/ethical-dilemma-template.md`
...
Load, read the full file and then execute `{project-root}/_bmad/strategy-team/workflows/ethical-dilemma-resolution/steps/step-01-init.md` to begin the workflow.
