...
Load, read the full file and then execute `{project-root}/_bmad/strategy-team/workflows/board-presentation-prep/steps/step-01-init.md` to begin the workflow.
