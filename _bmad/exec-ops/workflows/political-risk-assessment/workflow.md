...
- **Template:** `{project-root}/_bmad/exec-ops/workflows/_shared/templates/political-risk-template.md`
...
Load, read the full file and then execute `{project-root}/_bmad/exec-ops/workflows/political-risk-assessment/steps/step-01-init.md` to begin the workflow.
