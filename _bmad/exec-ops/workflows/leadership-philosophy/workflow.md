...
- **Template:** `{project-root}/_bmad/exec-ops/workflows/_shared/templates/leadership-philosophy-template.md`
...
This workflow is **personal development focused**, unlike other exec-ops workflows:

| Other Exec-Ops Workflows | Leadership Philosophy |
|--------------------------|----------------------|
...
Load, read the full file and then execute `{project-root}/_bmad/exec-ops/workflows/leadership-philosophy/steps/step-01-init.md` to begin the workflow.
