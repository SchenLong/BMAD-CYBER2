...
- **Template:** `{project-root}/_bmad/exec-ops/workflows/_shared/templates/conflict-resolution-template.md`
...
Load, read the full file and then execute `{project-root}/_bmad/exec-ops/workflows/conflict-resolution/steps/step-01-init.md` to begin the workflow.
