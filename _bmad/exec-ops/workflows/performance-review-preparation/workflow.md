...
Load, read the full file and then execute `{project-root}/_bmad/exec-ops/workflows/performance-review-preparation/steps/step-01-init.md` to begin the workflow.
