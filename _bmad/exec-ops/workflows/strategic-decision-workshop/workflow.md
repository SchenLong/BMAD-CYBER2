...
7. **Communication Plan** - Joseph develops stakeholder messaging
...
Load, read the full file and then execute `{project-root}/_bmad/exec-ops/workflows/strategic-decision-workshop/steps/step-01-init.md` to begin the workflow.
