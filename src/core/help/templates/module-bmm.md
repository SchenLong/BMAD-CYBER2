...
Full software development lifecycle management. 10 agents and 33 workflows
...
| Command | Description |
|---------|-------------|
| `/qa-automate` | Generate tests rapidly for existing features |

## Testing Workflows (Test Architect)
...
- **qa** -- Quick test automation engineer
- **tea** -- Test engineering and automation (enterprise)
