...
Examples:
  node check-authorization.js agent _bmad/intel-team/agents/osint-lead
...
function main() {
  ...
  if (!fs.existsSync(configPath)) {
    ...
    console.log('Run this from a project with src/core/security/rbac-config.yaml\n');
    process.exit(1);
  }
  ...
  if (!user) {
    ...
    console.log('    node src/core/security/quick-token.cjs "YourName" "admin"');
    console.log('');
    console.log('  Or run interactively:');
    console.log('    node src/core/security/generate-token.js');
    console.log('');
    console.log('======================================================================');
    console.log('');
