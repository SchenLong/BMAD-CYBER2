...
helpers: '{project-root}/src/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/src/core/resources/excalidraw/validate-json-instructions.md'
```
