...
Load config from `{project-root}/src/core/config.yaml` and resolve:
...
- `installed_path` = `{project-root}/src/core/workflows/brainstorming`
...
Load and follow `steps/step-01-session-setup.md` to begin the workflow.
