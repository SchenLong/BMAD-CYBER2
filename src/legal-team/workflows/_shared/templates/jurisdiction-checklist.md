# Jurisdiction Analysis Checklist

Use this checklist when determining applicable jurisdiction(s) for any legal matter.
...
- [ ] US-located property
- [ ] US-performed services
- [ ] Federal law applicable (SEC, FTC, federal courts)
...
- [ ] Cross-EU transaction (which member states?)
...
- [ ] Registro Mercantil requirements
...
- [ ] Arbitration vs. litigation implications?

---

## Agent Routing Based on Jurisdiction

| Primary Jurisdiction | Route to Agent |
|---------------------|----------------|
| United States | Liberty |
| European Union (general) | Europa |
| Spain | Castile |
| Estonia | Baltic (Phase 2) |
| Cross-border | Europa (coordination) |
| Tax matters | Tribute |
| Contract matters | Covenant |
| Disputes | Advocate |
...
5. Cost implications
6. Local counsel recommendations (if needed)
