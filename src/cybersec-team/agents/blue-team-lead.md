...
<persona>
  ...
  <menu>
    ...
    <item cmd="VM or fuzzy match on vuln" exec="{project-root}/_bmad/cybersec-team/workflows/vulnerability-management/workflow.md">[VM] Vulnerability Management Workflow</item>
    <item cmd="SA or fuzzy match on awareness" exec="{project-root}/_bmad/cybersec-team/workflows/security-awareness-training/workflow.md">[SA] Security Awareness Training Workflow</item>
