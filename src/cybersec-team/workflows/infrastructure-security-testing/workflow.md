...
Load, read the full file and then follow `{project-root}/src/cybersec-team/workflows/infrastructure-security-testing/steps/step-01-init.md` to begin the workflow.
