...
Load, read the full file and then follow `{project-root}/src/cybersec-team/workflows/incident-response-playbook/steps/step-01-init.md` to begin the workflow.
