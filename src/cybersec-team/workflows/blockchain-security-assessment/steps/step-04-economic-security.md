...
workflow_path: '{project-root}/_bmad/cybersec-team/workflows/blockchain-security-assessment'
...
ONLY WHEN economic assessment is documented and user confirms readiness will you update frontmatter to `stepsCompleted: [1, 2, 3, 4]`, then immediately load, read entire file, then follow `{nextStepFile}`.
