...
Load, read the full file and then execute `{project-root}/_bmad/cybersec-team/workflows/virtual-ciso-consulting/steps/step-01-init.md` to begin the workflow.
