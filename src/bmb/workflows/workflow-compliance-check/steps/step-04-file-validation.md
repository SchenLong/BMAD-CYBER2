...
csvStandards: '{project-root}/src/bmb/docs/workflows/csv-data-file-standards.md'
---
...
- IF C: Save file validation findings to report, update frontmatter, then load, read entire file, then follow {nextStepFile}
