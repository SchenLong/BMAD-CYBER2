...
# Path Definitions
workflow_path: '{project-root}/src/bmb/workflows/create-workflow'
...
# Template References
workflowTemplate: '{project-root}/src/bmb/docs/workflows/templates/workflow-template.md'
stepTemplate: '{project-root}/src/bmb/docs/workflows/templates/step-template.md'
stepInitContinuableTemplate: '{project-root}/src/bmb/docs/workflows/templates/step-01-init-continuable-template.md'
step1bTemplate: '{project-root}/src/bmb/docs/workflows/templates/step-1b-template.md'
...
- When building each step file, you must follow template `{project-root}/src/bmb/docs/workflows/templates/step-template.md`
- When building continuable step-01-init.md files, use template `{project-root}/src/bmb/docs/workflows/templates/step-01-init-continuable-template.md`
- When building continuation steps, use template `{project-root}/src/bmb/docs/workflows/templates/step-1b-template.md`
- When building the main workflow.md file, you must follow template `{project-root}/src/bmb/docs/workflows/templates/workflow-template.md`
- Example step files from {project-root}/src/bmb/reference/workflows/meal-prep-nutrition/workflow.md for patterns - this is an idealized workflow so all files can give good insight into format and structure to be followed
