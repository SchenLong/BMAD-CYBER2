...
commonToolsCsv: '{project-root}/src/bmb/docs/workflows/common-workflow-tools.csv'
...
- IF C: Save tools configuration to {workflowPlanFile}, update frontmatter, then load, read entire file, then follow {nextStepFile}
