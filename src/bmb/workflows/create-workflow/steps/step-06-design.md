...
- `{project-root}/src/bmb/docs/workflows/templates/step-template.md` - Step file structure
- `{project-root}/src/bmb/docs/workflows/templates/step-01-init-continuable-template.md` - Continuable init step template
- `{project-root}/src/bmb/docs/workflows/templates/step-1b-template.md` - Continuation step template
- `{project-root}/src/bmb/docs/workflows/templates/workflow-template.md` - Workflow configuration
- `{project-root}/src/bmb/reference/workflows/meal-prep-nutrition/workflow.md` - Complete example
...
```
Read: {project-root}/src/bmb/docs/workflows/templates/step-template.md
```

This shows the standard structure for step files. Also reference:

```
Read: {project-root}/src/bmb/docs/workflows/templates/step-1b-template.md
```
...
- IF C: Save design to {workflowPlanFile}, update frontmatter, then load, read entire file, then follow {nextStepFile}
