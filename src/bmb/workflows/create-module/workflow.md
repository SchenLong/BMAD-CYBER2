...
web_bundle: true
installed_path: '{project-root}/src/bmb/workflows/create-module'
---
...
Load and read full config from {project-root}/src/bmb/config.yaml and resolve:
...
**Before creating any module components, you MUST:**

1. Load and read `{project-root}/src/bmb/ExperienceAcquired/LessonsLearned.md`
...
Load, read the full file and then follow {installed_path}/steps/step-01-init.md to begin the workflow.
