...
complianceCheckWorkflow: '{project-root}/src/bmb/workflows/workflow-compliance-check/workflow.md'
outputFile: '{output_folder}/workflow-edit-{target_workflow_name}.md'

# Task References
complianceCheckTask: '{project-root}/src/bmb/workflows/workflow-compliance-check/workflow.md'
---
