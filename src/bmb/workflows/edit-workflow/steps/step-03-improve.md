...
- `{project-root}/src/bmb/docs/workflows/templates/step-template.md`
- `{project-root}/src/bmb/docs/workflows/templates/workflow-template.md`
- `{project-root}/src/bmb/docs/workflows/architecture.md`
