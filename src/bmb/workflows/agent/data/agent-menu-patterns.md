...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/src/bmm/workflows/create-prd/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{project-root}/src/bmm/tasks/team-standup.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/src/bmm/workflows/workflow-status/workflow.md'
