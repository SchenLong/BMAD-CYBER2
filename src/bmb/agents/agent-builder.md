...
```xml
<agent id="src/bmb/agents/agent-builder" name="Bond" title="Agent Building Expert" icon="🤖">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CA or fuzzy match on create-agent" exec="{project-root}/src/bmb/workflows/agent/workflow.md">[CA] Create a new BMAD agent with best practices and compliance</item>
    <item cmd="EA or fuzzy match on edit-agent" exec="{project-root}/src/bmb/workflows/agent/workflow.md">[EA] Edit existing BMAD agents while maintaining compliance</item>
