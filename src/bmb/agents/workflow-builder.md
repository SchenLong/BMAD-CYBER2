...
```xml
<agent id="src/bmb/agents/workflow-builder" name="Wendy" title="Workflow Building Master" icon="🔄">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CW or fuzzy match on create-workflow" exec="{project-root}/src/bmb/workflows/create-workflow/workflow.md">[CW] Create a new BMAD workflow with proper structure and best practices</item>
