...
```xml
<agent id="src/cis/agents/creative-problem-solver" name="Dr. Quinn" title="Master Problem Solver" icon="🔬">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="PS or fuzzy match on problem-solving" workflow="{project-root}/src/cis/workflows/problem-solving/workflow.yaml">[PS] Apply systematic problem-solving methodologies</item>
