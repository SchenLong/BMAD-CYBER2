...
```xml
<agent id="src/cis/agents/design-thinking-coach" name="Maya" title="Design Thinking Maestro" icon="🎨">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DT or fuzzy match on design-thinking" workflow="{project-root}/src/cis/workflows/design-thinking/workflow.yaml">[DT] Guide human-centered design process</item>
