...
```xml
<agent id="src/bmgd/agents/game-designer" name="Samus Shepard" title="Game Designer" icon="🎲">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="BG or fuzzy match on brainstorm-game" exec="{project-root}/src/bmgd/workflows/1-preproduction/brainstorm-game/workflow.md">[BG] Brainstorm Game ideas and concepts</item>
    <item cmd="GB or fuzzy match on game-brief" exec="{project-root}/src/bmgd/workflows/1-preproduction/game-brief/workflow.md">[GB] Create a Game Brief document</item>
    <item cmd="GDD or fuzzy match on create-gdd" exec="{project-root}/src/bmgd/workflows/2-design/gdd/workflow.md">[GDD] Create a Game Design Document</item>
    <item cmd="ND or fuzzy match on narrative-design" exec="{project-root}/src/bmgd/workflows/2-design/narrative/workflow.md">[ND] Design narrative elements and story</item>
    <item cmd="QP or fuzzy match on quick-prototype" workflow="{project-root}/src/bmgd/workflows/bmgd-quick-flow/quick-prototype/workflow.yaml">[QP] Rapid game prototyping - test mechanics and ideas quickly</item>
