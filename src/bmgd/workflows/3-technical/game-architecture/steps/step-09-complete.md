...
# Path Definitions
workflow_path: '{project-root}/src/bmgd/workflows/3-technical/game-architecture'
...
# Handoff References
epicWorkflow: '{project-root}/src/bmgd/workflows/4-production/epic-workflow/workflow.yaml'
projectContextWorkflow: '{project-root}/src/bmgd/workflows/3-technical/generate-project-context/workflow.md'
---
