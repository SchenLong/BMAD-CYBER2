...
# Path Definitions
workflow_path: '{project-root}/src/bmgd/workflows/2-design/gdd'
...
# Workflow References
narrativeWorkflow: '{project-root}/src/bmgd/workflows/2-design/narrative/workflow.yaml'
architectureWorkflow: '{project-root}/src/bmgd/workflows/3-technical/game-architecture/workflow.yaml'
---
