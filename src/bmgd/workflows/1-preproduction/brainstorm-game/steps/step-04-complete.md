...
# Path Definitions
workflow_path: '{project-root}/src/bmgd/workflows/1-preproduction/brainstorm-game'
...
# Handoff References
gameBriefWorkflow: '{project-root}/src/bmgd/workflows/1-preproduction/game-brief/workflow.yaml'
gddWorkflow: '{project-root}/src/bmgd/workflows/2-design/gdd/workflow.yaml'
---
