...
<critical>You MUST have already loaded and processed: {project-root}/src/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/src/bmm/workflows/workflow-status">
...
Your choice [1/2/3]:
  ...
  <check if="user selects 1">
    ...
    <check if="workflow_mode == deep_dive">
      <action>Load and follow: {installed_path}/workflows/deep-dive-instructions.md with resume context</action>
    </check>

    <check if="workflow_mode == initial_scan OR workflow_mode == full_rescan">
      <action>Load and follow: {installed_path}/workflows/full-scan-instructions.md with resume context</action>
    </check>
...
Your choice [1/2/3]:
  ...
  <check if="user selects 1">
    ...
    <action>Load and follow: {installed_path}/workflows/full-scan-instructions.md</action>
  ...
  <check if="user selects 2">
    ...
    <action>Load and follow: {installed_path}/workflows/deep-dive-instructions.md</action>
    <action>After sub-workflow completes, continue to Step 4</action>
  </check>
