...
# Path Definitions
workflow_path: '{project-root}/src/bmm/workflows/1-analysis/create-product-brief'
...
- IF C: Save content to {outputFile}, update frontmatter with stepsCompleted: [1, 2, 3, 4, 5], then only then load, read entire file, then follow {nextStepFile}
