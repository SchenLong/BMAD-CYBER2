...
workflow_path: '{project-root}/src/bmm/workflows/bmad-quick-flow/create-tech-spec'
...
- **[b]**: Load and follow `{quick_dev_workflow}` with the final spec file (warn: fresh context is better)
...
- **[r]**: Execute Adversarial Review:
    1. **Load Adversarial Review Task**:
