...
Load and read full config from {project-root}/src/bmm/config.yaml and resolve:
...
Load, read the full file and then follow `{project-root}/src/bmm/workflows/3-solutioning/create-epics-and-stories/steps/step-01-validate-prerequisites.md` to begin the workflow.
