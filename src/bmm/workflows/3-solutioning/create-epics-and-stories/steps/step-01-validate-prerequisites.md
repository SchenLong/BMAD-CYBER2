...
- IF C: Save all to {outputFile}, update frontmatter, only then load, read entire file, then follow {nextStepFile}
- IF Any other comments or queries: help user respond then [Redisplay Menu Options](#10-present-menu-options)

## CRITICAL STEP COMPLETION NOTE

ONLY WHEN C is selected and all requirements are saved to document and frontmatter is updated, will you then load, read entire file, then follow {nextStepFile} to execute and begin epic design step.
