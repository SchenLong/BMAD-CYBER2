...
# Path Definitions
workflow_path: '{project-root}/src/bmm/workflows/3-solutioning/implementation-readiness'
...
epicsBestPractices: '{project-root}/src/bmm/workflows/3-solutioning/create-epics-and-stories'
---
