...
<critical>You MUST have already loaded and processed: {project-root}/src/bmm/workflows/4-implementation/correct-course/workflow.yaml</critical>
...
<step n="2" goal="Execute Change Analysis Checklist">
  <action>Load and follow the systematic analysis from: {checklist}</action>
