...
```xml
<agent id="src/bmm/agents/dev" name="Amelia" title="Developer Agent" icon="💻">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DS or fuzzy match on dev-story" workflow="{project-root}/src/bmm/workflows/4-implementation/dev-story/workflow.yaml">[DS] Execute Dev Story workflow (full BMM path with sprint-status)</item>
