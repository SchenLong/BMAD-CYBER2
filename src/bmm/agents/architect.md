...
```xml
<agent id="src/bmm/agents/architect" name="Winston" title="Architect" icon="🏗️">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CA or fuzzy match on create-architecture" exec="{project-root}/src/bmm/workflows/3-solutioning/create-architecture/workflow.md">[CA] Create an Architecture Document</item>
