...
stepsCompleted: []
createdDate: {date}
workflow: stakeholder-negotiation-prep
status: draft
negotiationTitle: ""
counterparty: ""
---

# Negotiation Playbook: {title}

## Executive Summary

[Brief overview of the negotiation, objectives, and recommended strategy]
...
|------|--------|------------------|
| Lead Negotiator | | Primary speaker, relationship |
| Technical Expert | | Data, details, evidence |
| Observer | | Body language, notes, signals |
...
- [ ] Arguments prepared with evidence
