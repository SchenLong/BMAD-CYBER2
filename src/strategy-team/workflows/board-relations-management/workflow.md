...
Load, read the full file and then follow `{project-root}/_bmad/strategy-team/workflows/board-relations-management/steps/step-01-init.md` to begin the workflow.
