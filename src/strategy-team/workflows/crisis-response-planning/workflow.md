...
Load, read the full file and then execute `{project-root}/_bmad/strategy-team/workflows/crisis-response-planning/steps/step-01-init.md` to begin the workflow.
