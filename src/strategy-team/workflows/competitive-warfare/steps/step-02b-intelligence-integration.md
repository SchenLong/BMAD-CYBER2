---
name: step-02b-intelligence-integration
description: Cross-module intelligence integration for competitive warfare - brings in Intel team for deep competitor analysis

outputFile: '{output_folder}/warfare/competitive-warfare-{campaign}.md'
nextStepFile: './step-03-self-assessment.md'
previousStepFile: './step-02-enemy-analysis.md'

# Cross-module integration
partyModePresetsFile: '{project-root}/_bmad/core/workflows/party-mode/presets/cross-module-groups.yaml'
recommendedPreset: 'strategic-intelligence-council'
---
...
- Need to verify assumptions before committing to strategy
- Competitor has complex organizational structure
- International or cross-border competitive dynamics
...
**Sun Tzu introduction:**

"*Intelligence is of the essence in warfare - it is what the armies depend upon to make their every move.*

Our initial enemy analysis provides a framework. But frameworks built on assumption are castles on sand. Let me bring in those who specialize in turning assumption into knowledge."

### 2. Offer Intelligence Integration
...
- **Network mapping** - Alliances, partnerships, influence networks

This transforms assumptions into verified intelligence.

**Select:**
[I] Integrate Intel - bring in intelligence team
[S] Skip - proceed with current analysis"

**IF S: Skip to Continue**
**IF I: Continue with intelligence integration**

### 3. Activate Intelligence Team

**Load the strategic-intelligence-council:**
...
### 4. OSINT Collection (Vector)

**Vector's intelligence synthesis:**

"**Vector here.** Let me provide the intelligence picture...
...
| Financial position | [findings] | [H/M/L] | [sources] |
| Market position | [findings] | [H/M/L] | [sources] |
| Technology capabilities | [findings] | [H/M/L] | [sources] |
...
- Regulatory filings: [business signals]
...
### 5. Leadership Profiling (Dossier)

**Dossier's leadership analysis:**

"**Dossier here.** Let me profile the key decision-makers...
...
| Decision style | [analytical/intuitive/consensus] | [past decisions] | [H/M/L] |
| Risk tolerance | [high/moderate/low] | [examples] | [H/M/L] |
| Strategic orientation | [aggressive/defensive/opportunistic] | [pattern] | [H/M/L] |
| Known weaknesses | [identified patterns] | [instances] | [H/M/L] |
| Pressure points | [what motivates/concerns them] | [signals] | [H/M/L] |
...
### 6. Corporate Intelligence (Proxy)

**Proxy's corporate analysis:**

"**Proxy here.** Follow the paper trail...
...
| Cash position | [figure] | [up/down/flat] | [war chest assessment] |
| Debt levels | [figure] | [up/down/flat] | [constraints] |
| R&D spending | [figure] | [up/down/flat] | [strategic direction] |
...
- Operational dependencies: [critical vendors, partners]
...
### 7. Communications Analysis (Echo)

**Echo's sentiment and messaging analysis:**

"**Echo here.** Let me read the signals...
...
**Vector's integrated assessment:**

"**Vector here.** Let me synthesize the intelligence picture...
...
| [Assessment 2] | [Verified/Partially Verified/Unverified] | [H/M/L] |
...
**Intelligence-Adjusted Competitor Profile:**

| Dimension | Initial Assessment | Intelligence-Adjusted | Change |
|-----------|-------------------|----------------------|--------|
| Greatest strength | [initial] | [adjusted] | [significant/minor/none] |
| Greatest weakness | [initial] | [adjusted] | [significant/minor/none] |
| Most likely move | [initial] | [adjusted] | [significant/minor/none] |
...
Key assumptions that could invalidate this assessment: [list]"

### 9. Sun's Integration

**Sun Tzu integrates intelligence:**

"*The reason the enlightened prince and the wise general conquer the enemy whenever they move... is foreknowledge.*

The intelligence picture refines our understanding:

**What We Now Know:**
[Key verified intelligence]

**What Remains Uncertain:**
[Key intelligence gaps]

**How This Changes Our Strategy:**
[Strategic adjustments based on intelligence]

**Warning:** Intelligence provides clarity, but the enemy can still surprise us. We proceed with eyes open."

### 10. Update Output File

**Append to {outputFile}:**

```markdown
## 2b. Intelligence Integration

### OSINT Assessment (Vector)
**Intelligence Overview:**
[Intelligence table]

**Intelligence Gaps:** [list]

### Leadership Profiling (Dossier)
**Key Leader Profiles:**
[Profile summaries]
...
### Intelligence Synthesis (Vector)
**Overall Confidence:** [level]

**Intelligence-Adjusted Profile:**
[Adjusted assessment table]
...
### Sun's Integration
**Strategic Adjustment:** [how intelligence changes approach]
```

Update frontmatter: add `step-02b-intelligence-integration` to stepsCompleted

### 11. Menu Options

**Present options:**

"{user_name}, intelligence integration is complete.

**Select:**
[D] Discuss specific intelligence with analysts
[P] Party Mode - Full strategic intelligence council
[M] Monitor - Set up ongoing intelligence requirements
[C] Continue to Self-Assessment (with intelligence-enhanced enemy profile)"
...
- Corporate intelligence analyzed for strategic implications
- Communications patterns identified
- Initial assessments verified or adjusted
...
- Missing key intelligence sources
- Not adjusting strategy based on intelligence
- Failing to identify intelligence gaps
