...
# Path Definitions
workflow_path: '{project-root}/src/intel-team/workflows/digital-necromancy'
...
Load, read the full file and then follow `{workflow_path}/steps/step-01-deep-historical.md` to begin the workflow.
