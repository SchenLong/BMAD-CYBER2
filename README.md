...
[![LM Studio](https://img.shields.io/badge/LLM-LM%20Studio-orange.svg)](https://lmstudio.ai)
[![GLM](https://img.shields.io/badge/LLM-GLM-red.svg)](https://github.com/THUDM/GLM)
[![Kimi](https://img.shields.io/badge/LLM-Kimi-cyan.svg)](https://kimi.moonshot.cn)
[![vLLM](https://img.shields.io/badge/LLM-vLLM-yellow.svg)](https://github.com/vllm-project/vllm)
[![Groq](https://img.shields.io/badge/LLM-Groq-success.svg)](https://groq.com)
...
[![TPI-CrowdStrike](https://img.shields.io/badge/TPI--CrowdStrike-Compliant-brightgreen.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![OWASP LLM 95/100](https://img.shields.io/badge/OWASP%20LLM-95%2F100-brightgreen.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![OWASP Top 10](https://img.shields.io/badge/OWASP-Top%2010-brightgreen.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![OWASP API Top 10](https://img.shields.io/badge/OWASP-API-Top%2010-brightgreen.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![ASVS v4.0](https://img.shields.io/badge/OWASP-ASVS%204.0-brightgreen.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![SOC 2 Ready](https://img.shields.io/badge/compliance-SOC%202%20ready-purple.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![GDPR Compliant](https://img.shields.io/badge/compliance-GDPR%20compliant-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![ISO 27001](https://img.shields.io/badge/compliance-ISO%2027001-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![NIST 800-53](https://img.shields.io/badge/compliance-NIST%20800--53-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![PCI-DSS](https://img.shields.io/badge/compliance-PCI--DSS-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![HIPAA](https://img.shields.io/badge/compliance-HIPAA%20ready-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![FedRAMP](https://img.shields.io/badge/compliance-FedRAMP%20ready-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)
[![CMMC](https://img.shields.io/badge/compliance-CMMC%20ready-blue.svg)](Docs/02-user-guides/SECURITY-OVERVIEW.md)

<!-- Testing Coverage -->
### ✅ Testing & Quality
[![7,117+ Tests](https://img.shields.io/badge/tests-7117%2B-brightgreen.svg)](tests/)
[![208 Test Files](https://img.shields.io/badge/test%20files-208-blue.svg)](tests/)
[![Zero Regressions](https://img.shields.io/badge/regressions-0-success.svg)](tests/)

<!-- Quick Links -->
[Quick Start](#-quick-start) · [Features](#-features) · [Security](#-security-features) · [Documentation](#-documentation) · [Changelog](#-changelog)
...
| [Agents Reference](Docs/02-user-guides/AGENTS-REFERENCE.md) | All agents by team with capabilities |
| [Slash Command Reference](Docs/02-user-guides/SLASH-COMMAND-REFERENCE.md) | Direct invocation guide (112 aliases) |
| [Workflows Reference](Docs/02-user-guides/WORKFLOWS-REFERENCE.md) | All 200+ workflows documented |
| [Security Overview](Docs/02-user-guides/SECURITY-OVERVIEW.md) | Security architecture and hardening |
| [Security Advanced Topics](Docs/02-user-guides/Security/) | Audit logs, chain of custody, RBAC operations |
...
| [Configuration Guide](Docs/02-user-guides/CONFIGURATION-GUIDE.md) | System configuration options |
| [RBAC Roles Guide](Docs/02-user-guides/RBAC-ROLES-GUIDE.md) | Role-based access control |
