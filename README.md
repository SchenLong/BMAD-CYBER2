...
**Professional-grade AI agent modules for cybersecurity, intelligence operations, executive leadership, and legal support**
...
|----------|-------------|
| 👥 **[Meet Your Teams](docs/AGENTS.md)** | Complete guide to all 55+ AI agents across all modules |
| 🔄 **[Workflows Reference](docs/WORKFLOWS.md)** | All 80+ workflows with details and use cases |
...
> ⚠️ Legal-Team workflows can technically be use as standalone module but are **not recommended for standalone use** - designed for Party Mode support only.
...
│   │   └── README.md
│   │
│   ├── intel-team/                    # 🕵️ Intelligence module (v1.1.0)
│   │   ├── agents/                    # 11 agent definitions
│   │   ├── workflows/                 # 19 production workflows
...
│   │   └── README.md
│   │
│   ├── bmm/                           # 💻 Software development (BMAD Method)
│   ├── bmgd/                          # 🎮 Game development
│   ├── bmb/                           # 🔧 Module builder
│   └── core/                          # ⚙️ Core BMAD components
│
├── docs/
│   ├── AGENTS.md                      # 👥 All agents reference
│   ├── WORKFLOWS.md                   # 🔄 All workflows reference
...
```bash
# 🔐 Security: Bastion + Ghost + Nimbus (defense + offense + cloud)
# 🚨 Incident: Phoenix + Trace + Cipher + Watchman
# 🕵️ Intelligence: Vector + Resolver + Echo + Shadow + Atlas + Probe
# 👔 Executive: All 8 archetype advisors for strategic decisions
# ⚖️ Cross-Module: Any team + Legal (Counsel, Liberty, Europa, Castile)
```

**Legal Team in Party Mode:** Add legal perspective to any scenario - compliance considerations during security assessments, contractual implications in intelligence operations, or regulatory concerns in executive strategy.
...
- **NEW:** Prompt Injection Protection added to all 47 agents
- **NEW:** External Content Manipulation Protection added to all 47 agents
